...
# Semantic implementation mainly
...
class DataStream:
    ...
    def output_pipeline(self, nb: int, plugin: ExportPlugin) -> None:
        # This is supposed to be used after calling process_stream
        for proc in self._registered:
...
# Duck classes automatically inhenrit from Protocol class
class CSVPlugin:
    def process_output(self, data: list[tuple[int, str]]) -> None:
        print("CSV Output:")
        csv_str: list[str] = []
...
class JSONPlugin:
    def process_output(self, data: list[tuple[int, str]]) -> None:
        ...
        pairs = ", ".join(f'"{k}": "{v}"' for k, v in json_dict.items())
        print("{" + pairs + "}")
...
def main() -> None:
    ...
    print("Send first batch of data on stream:", BATCH_1, end="\n\n")
    ...
    print()
    ds.print_processors_stats()
    print("\nSend another batch of data:", BATCH_2, end="\n\n")
